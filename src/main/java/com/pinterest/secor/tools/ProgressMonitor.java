        ...
        for (String topic : topics) {
            ...
            for (Integer partition : partitions) {
                try {
                    ...
                    if (e.toString().startsWith("java.lang.RuntimeException: Error fetching offset data. Reason: 1")) {
                        LOG.warn("Problem reporting stats for topic {}, because missing messages not available in Kafka",
                                topic);
                    } else {
                        throw e;
                    }
